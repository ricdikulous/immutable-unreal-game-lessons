...
In the previous lesson we created the contract for the collection and wrote code to upload the collection metadata to our S3 bucket. You can check that out [here](../09-upload-nft-collection-metadata-and-create-the-smart-contract/README.md).
...
[Lesson 11: Mint NFTs](../11-mint-nfts/README.md)
