# Lesson 11: Mint an NFTs
In Lesson 11, we implement the core functionality of minting NFTs using the Immutable SDK in our server.
...
- Completion of previous lessons covering the setup of the environment file and [Dynamically Update Metadata](../10-dynamically-upload-metadata/README.md).
...
[Lesson 12: Retrieve NFTs](../12-retrieve-nfts/README.md)
